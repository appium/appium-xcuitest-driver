...
import url from 'url';
import v8 from 'v8';
import { DEVICE_TYPE_TVOS } from './desired-caps';
 ...
 */
function isTvOS (deviceType) {
  return _.toLower(deviceType) === _.toLower(DEVICE_TYPE_TVOS);
}
...
function getDeviceOSType (deviceType) {
  if (_.toLower(deviceType) === _.toLower(DEVICE_TYPE_TVOS)) {
...
export { detectUdid, getAndCheckXcodeVersion, getAndCheckIosSdkVersion,
  ...
  verifyApplicationPlatform, isTvOS, getDeviceOSType, DEVICE_OS_IOS, DEVICE_OS_TVOS };
