...
const APPLICATION_PUSH_TIMEOUT = 30 * 1000;
    ...
    try {
      ...
      await fs.walkDir(app, true, async (itemPath, isDir) => {
        ...
        if (isDir) {
          ...
          const filePush = new B((resolve, reject) => {
          ...
          try {
            ...
            throw new Error(`Couldn't push the file '${itemPath}' within the timeout ${APPLICATION_PUSH_TIMEOUT}ms. Error: ${e.message}`);
          }
        }
      });
