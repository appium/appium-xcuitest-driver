 ...
 */
function createThrottledFunction(fn, delay = 100) {
 ...
 */
async function parallelWithConcurrency(items, processor, concurrency = 5) {
 ...
 */
const globalPerformanceCache = new PerformanceCache();
