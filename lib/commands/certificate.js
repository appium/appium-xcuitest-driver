 ...
 * @property {?boolean} isRoot [true] - The certificate destination.
 * This option defines where the certificate should be
...
commands.mobileInstallCertificate = async function mobileInstallCertificate (opts = {}) {
  ...
  if (this.isSimulator()) {
    try {
      return void (await this.opts.device.addCertificate(content, {isRoot}));
    } catch (e) {
      log.debug(e);
