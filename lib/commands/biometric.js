 ...
 *
 * @property {?boolean} type [touchId] - The biometric feature name
 * @property {?string} match [true] - Whether to simulate biometric match or non-match
 */

/**
 * Emulate biometric match event on Simulator.
