...
helpers.cacheElement = function cacheElement (el, strict = true) {
...
helpers.cacheWebElements = function cacheWebElements (rawEl) {
  ...
  return _.isArray(rawEl)
    ? rawEl.map((el) => this.cacheElement(el))
    : this.cacheElement(rawEl);
};
