  ...
  async start () {
    ...
    try {
      ...
      this._logger.errorAndThrow(`There is no .${DEFAULT_EXT} file found for performance profile ` +
        `'${this._profileName}' after ${STARTUP_TIMEOUT_MS}ms. Make sure the profile is supported ` +
        `on this device. You can use 'instruments -s' command to see the list of all available profiles. ` +
