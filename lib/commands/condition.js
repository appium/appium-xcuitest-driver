...
function requireConditionInducerCompatibleDevice (driver) {
    ...
    if (util.compareVersions(this.opts.platformVersion, '<', '13.0')) {
 ...
 * @property {Array<profiles>} profiles
...
/**
 * @typedef {Object} ConditionInducers
 * @property {Array<Condition>} Conditions list of all profile
 */
 ...
 * }]
 */
commands.mobileListConditionInducerProfiles = async function listConditionInducerProfiles () {
