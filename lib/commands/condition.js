...
async function closeRemoteXPC(driver) {
  if (driver._remoteXPCConditionInducerConnection) {
    await driver._remoteXPCConditionInducerConnection.remoteXPC.close();
    driver._remoteXPCConditionInducerConnection = null;
  }
}
