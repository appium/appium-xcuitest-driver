...
import {fs, tempDir, zip, util} from 'appium/support.js';

import {AfcClient} from '../device/afc-client.js';
import {
...
import type {ContainerObject, ContainerRootSupplier} from './types.js';
