...
helpers.mobileDragFromToWithVelocity = async function mobileDragFromToWithVelocity (opts = {}) {
  const params = {
    pressDuration: requireFloatParameter('pressDuration', opts.duration, 'dragFromToWithVelocity'),
    holdDuration: requireFloatParameter('holdDuration', opts.duration, 'dragFromToWithVelocity'),
    velocity: requireFloatParameter('velocity', opts.duration, 'dragFromToWithVelocity'),
  };
  const elementId = toElementId(opts);
  if (elementId) {
    ...
    return await this.proxyCommand(`/wda/element/${elementId}/pressAndDragWithVelocity`, 'POST', params);
  }
