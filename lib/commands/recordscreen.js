...
commands.startRecordingScreen = async function (options = {}) {
  const {videoType, timeLimit, forceRestart} = options;
  if (this.isRealDevice()) {
    throw new Error('Screen recording is not implemnted for real devices');
  }
  ...
  const args = ['simctl', 'io', this.opts.device.udid, 'recordVideo'];
