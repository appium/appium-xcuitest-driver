...
commands.mobileIsAppInstalled = async function (opts = {}) {
  return await this.opts.device.isAppInstalled(parseOptions(opts));
};

commands.mobileRemoveApp = async function (opts = {}) {
  const {bundleId} = parseOptions(opts);
...
commands.mobileLaunchApp = async function (opts = {}) {
  return await this.proxyCommand('/wda/apps/launch', 'POST', parseOptions(opts));
};

commands.mobileTerminateApp = async function (opts = {}) {
  return await this.proxyCommand('/wda/apps/terminate', 'POST', parseOptions(opts));
};

commands.mobileActivateApp = async function (opts = {}) {
  return await this.proxyCommand('/wda/apps/activate', 'POST', parseOptions(opts));
};

commands.mobileQueryAppState = async function (opts = {}) {
  return await this.proxyCommand('/wda/apps/state', 'POST', parseOptions(opts));
};
