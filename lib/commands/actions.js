...
commands.mobileLaunchApp = async function (opts = {}) {
  return await this.proxyCommand('/session/apps/launch', 'POST', verifyOptions(opts));
};

commands.mobileTerminateApp = async function (opts = {}) {
  return await this.proxyCommand('/session/apps/terminate', 'POST', verifyOptions(opts));
};

commands.mobileActivateApp = async function (opts = {}) {
  return await this.proxyCommand('/session/apps/activate', 'POST', verifyOptions(opts));
};

commands.mobileQueryAppState = async function (opts = {}) {
  return await this.proxyCommand('/session/apps/state', 'POST', verifyOptions(opts));
};
