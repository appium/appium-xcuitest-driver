...
commands.mobileLaunchApp = async function (bundleId) {
  return await this.proxyCommand('/session/apps/launch', 'POST', {bundleId});
};

commands.mobileTerminateApp = async function (bundleId) {
  return await this.proxyCommand('/session/apps/terminate', 'POST', {bundleId});
};

commands.mobileActivateApp = async function (bundleId) {
  return await this.proxyCommand('/session/apps/activate', 'POST', {bundleId});
};

commands.mobileQueryAppState = async function (bundleId) {
  return await this.proxyCommand('/session/apps/state', 'POST', {bundleId});
};
