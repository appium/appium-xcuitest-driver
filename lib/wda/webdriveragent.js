...
const WDA_LAUNCH_RETRY = 2;
const WDA_LAUNCH_DELAY = 2 * 1000;
...
class WebDriverAgent {
  ...
  async launch (sessionId) {
    ...
    return await retryInterval(WDA_LAUNCH_RETRY, WDA_LAUNCH_DELAY,
      this.xcodebuild.start.bind(this.xcodebuild));
  }
