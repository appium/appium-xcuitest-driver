...
function getXctestrunFilePathName (deviceInfo, version) {
  if (deviceInfo.platformNameLowerCase === 'tvos') {
    return `WebDriverAgentRunner_tvOS_appletv${deviceInfo.isRealDevice ? `os${version}-arm64` : `simulator${version}-x86_64`}.xctestrun`;
  }
  return `WebDriverAgentRunner_iphone${deviceInfo.isRealDevice ? `os${version}-arm64` : `simulator${version}-x86_64`}.xctestrun`;
}
