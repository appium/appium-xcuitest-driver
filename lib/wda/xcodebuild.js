...
class XcodeBuild {
  ...
  async cleanProject () {
    const libScheme = _.toLower(this.platformName) === _.toLower(PLATFORM_NAME_TVOS) ? LIB_SCHEME_TV : LIB_SCHEME;
    const runnerScheme = _.toLower(this.platformName) === _.toLower(PLATFORM_NAME_TVOS) ? RUNNER_SCHEME_TV : RUNNER_SCHEME;
