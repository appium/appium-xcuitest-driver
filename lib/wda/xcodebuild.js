...
class XcodeBuild {
  ...
  async init (noSessionProxy) {
    ...
    if (this.useXctestrunFile) {
      ...
      this.xctestrunFilePath = await setXctestrunFile(this.realDevice, this.device.udid, this.platformVersion, this.iosSdkVersion, this.bootstrapPath, this.wdaRemotePort);
      return;
    }
