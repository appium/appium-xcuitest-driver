...
class XcodeBuild {
  constructor (xcodeVersion, device, args = {}) {
    ...
    this.platformNameLowerCase = args.platformName ? args.platformName.toLowerCase() : args.platformName;
  ...
  async init (noSessionProxy) {
    ...
    if (this.useXctestrunFile) {
      ...
      const deviveInfo = {
        ...
        platformNameLowerCase: this.platformNameLowerCase
      };
  ...
  async cleanProject () {
    let lib_scheme = this.platformNameLowerCase === 'tvos' ? LIB_SCHEME_TV : LIB_SCHEME;
    let runner_scheme = this.platformNameLowerCase === 'tvos' ? RUNNER_SCHEME_TV : RUNNER_SCHEME;
  ...
  getCommand (buildOnly = false) {
    ...
    if (this.useXctestrunFile) {
      ...
      const runner_scheme = this.platformNameLowerCase === 'tvos' ? RUNNER_SCHEME_TV : RUNNER_SCHEME;
