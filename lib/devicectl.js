...
export class Devicectl {
   ...
   * @property {import('@appium/types').StringRecord<string|number>} [env] environment variables for the launching app process
   * @property {boolean} [terminateExisting=false] if terminating the already running app
   */
