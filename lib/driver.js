...
import {
  ...
  printUser, removeAllSessionWebSocketHandlers, verifyApplicationPlatform,
...
class XCUITestDriver extends BaseDriver {
  ...
  async getSession () {
    ...
    if (shouldGetDeviceCaps) {
      log.warn(`Please call 'mobile:deviceScreenInfo' to get 'pixelRatio' and 'statBarHeight', ` +
        `'mobile:viewportRect' to get 'viewportRect'. They will be removed from this method in near future release.`);
    }
