...
import {
  ...
  normalizePlatformVersion, isLocalHost, parseWebkitDebugProxyPort,
  parseWdaLocalPort
} from './utils';
import {
...
const WEBKIT_DEBUG_PROXY_PORT = 27753;
...
class XCUITestDriver extends BaseDriver {
  constructor (opts = {}, shouldValidateCaps = true, driverArgs = {}) {
    opts.webkitDebugProxyPort = parseWebkitDebugProxyPort(driverArgs);
    opts.wdaLocalPort = parseWdaLocalPort(driverArgs);
...
export { XCUITestDriver, WEBKIT_DEBUG_PROXY_PORT, WEBDRIVERAGENT_PORT };
