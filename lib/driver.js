...
import { killAllSimulators, simExists, getSimulator, installSSLCert } from 'appium-ios-simulator';
...
class XCUITestDriver extends BaseDriver {
  ...
  async start () {
    ...
    if (!this.opts.realDevice && this.opts.customSSLCert) {
      installSSLCert(this.opts.customSSLCert, this.opts.udid);
    }
