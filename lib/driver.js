...
class XCUITestDriver extends BaseDriver {
  ...
  async getSession () {
    ...
    if (!this.deviceCaps) {
      this.deviceCaps = {};
      this.deviceCaps.pixelRatio = await this.getDevicePixelRatio();
      this.deviceCaps.statBarHeight = await this.getStatusBarHeight();
      this.deviceCaps.viewportRect = await this.getViewportRect();
    }
