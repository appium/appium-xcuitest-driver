...
export class XCUITestDriver extends BaseDriver {
  ...
  /**
   * Print deprecated capabilities.
   */
  printDeprecatedCaps() {
    if (this.opts.useSimpleBuildTest) {
      this.log.warn("'appium:useSimpleBuildTest' is deprecated, which was to build the WebDriverAgent project with 'build' and " +
        "'test' legacy commands for older than Xcode 8. Please remove the capability to use newer 'build-for-testing' and 'test-without-building'.");
    }
  }
