...
const DEFAULT_SETTINGS = {
  ...
  screenshotQuality: 1 // https://github.com/appium/WebDriverAgent/blob/master/WebDriverAgentLib/Utilities/FBConfiguration.m#L31
};
  ...
  async createSession (...args) {
    ...
    try {
      ...
      let wdaSettings = {
        ...
        screenshotQuality: DEFAULT_SETTINGS.screenshotQuality,
      };
