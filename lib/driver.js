...
import { detectUdid, getAndCheckXcodeVersion, getAndCheckIosSdkVersion,
         ...
         DEFAULT_TIMEOUT_KEY, resetXCTestProcesses, markSystemFilesForCleanup,
...
class XCUITestDriver extends BaseDriver {
  ...
  async startSim () {
    ...
    runOpts.devicePreferences = {
      simulatorWindowCenter: this.opts.simulatorWindowCenter,
    };
    ...
    switch (orientation) {
      case 'LANDSCAPE':
        runOpts.devicePreferences = Object.assign({}, runOpts.devicePreferences, {
