      ...
      await retryInterval(startupRetries, startupRetryInterval, async () => {
        ...
        try {
          if (this.isRealDevice() && this.opts.usePreinstalledWDA) {
            ...
            const launchWDABundleID =
              this.opts.updatedWDABundleId || 'com.facebook.WebDriverAgentRunner.xctrunner';
            this.mobileKillApp(launchWDABundleID);
            this.xctestWDA = new Xctest(this.opts.udid, launchWDABundleID, null, {env});
