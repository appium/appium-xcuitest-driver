...
import {
  ...
  printUser, removeAllSessionWebSocketHandlers, verifyApplicationPlatform, getDeviceOSType } from './utils';
import {
...
class XCUITestDriver extends BaseDriver {
  ...
  async createSim () {
    ...
    // create sim for caps
    let sim = await createSim(this.opts, getDeviceOSType(this.opts.deviceType));
