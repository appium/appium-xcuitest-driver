...
class XCUITestDriver extends BaseDriver {
  ...
  constructor(opts = {}, shouldValidateCaps = true) {
    ...
    this.logs = {};
    this._trafficCapture = commands.pcapExtensions._trafficCapture;
  ...
  isKeyboardShown = commands.elementExtensions.isKeyboardShown;
  ...
  hideKeyboard = commands.generalExtensions.hideKeyboard;
  getStrings = commands.generalExtensions.getStrings;
  ...
  _trafficCapture = commands.pcapExtensions._trafficCapture;
