...
class XCUITestDriver extends BaseDriver {
  ...
  async startWda (sessionId, realDevice) {
    ...
    await DEVICE_CONNECTIONS_FACTORY.requestConnection(this.udid, this.wda.url.port, {
  ...
  async stop () {
    ...
    DEVICE_CONNECTIONS_FACTORY.releaseConnection(this.udid, (this.wda || {}).url.port);
