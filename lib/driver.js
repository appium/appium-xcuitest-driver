...
class XCUITestDriver extends BaseDriver {
  ...
  /*----------------------+
   ...
   +---------------------+*/
  mobileStartXctestScreenRecording = commands.mobileStartXctestScreenRecording;
  mobileGetXctestScreenRecordingInfo = commands.mobileGetXctestScreenRecordingInfo;
  mobileStopXctestScreenRecording = commands.mobileStopXctestScreenRecording;
}
