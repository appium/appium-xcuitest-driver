...
class XCUITestDriver extends BaseDriver {
  ...
  async startWdaSession(bundleId, processArguments) {
    ...
    if (this.isSafari() && this.isDeepLinkingSupported()) {
   ...
   * @returns {boolean}
   */
  isDeepLinkingSupported() {
    return Boolean(this.opts.platformVersion && util.compareVersions(this.opts.platformVersion, '>=', '16.4'));
  }
