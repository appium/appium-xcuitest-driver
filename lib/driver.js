...
import { globalPerformanceCache, globalMemoryMonitor, globalPerformanceTimer } from './performance-optimizations';
...
const WEB_ELEMENTS_CACHE_SIZE = parseInt(process.env.APPIUM_WEB_ELEMENTS_CACHE_SIZE || '500', 10);
