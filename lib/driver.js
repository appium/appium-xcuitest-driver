  ...
  async installAUT() {
    ...
    if (install) {
      if (this.isRealDevice()) {
        ...
        // Real devices could return true for isAppInstalled function even
        // the device has no the bundle id.
        ...
        if (this.opts.enforceAppInstall !== false || this.opts.fullReset) {
          this.logs.debug(`Enforce to uninstall ${this.opts.bundleId} before the installation.`);
