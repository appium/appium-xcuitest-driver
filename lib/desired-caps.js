...
const DEVICE_TYPE_TVOS = 'tv';

let desiredCapConstraints = _.defaults({
  deviceType: { // So far, this type is only xcuitest
    isString: true,
    inclusionCaseInsensitive: [DEVICE_TYPE_TVOS, DEVICE_TYPE_IPHONE, DEVICE_TYPE_IPAD]
  },
  showXcodeLog: {
    isBoolean: true
  },
...
export { desiredCapConstraints, DEVICE_TYPE_TVOS };
