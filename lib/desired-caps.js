...
let desiredCapConstraints = _.defaults({
  deviceType: { // this type is used only for xcuitest to detect test target device
    isString: true,
    inclusionCaseInsensitive: [DEVICE_TYPE_TV, DEVICE_TYPE_IPHONE, DEVICE_TYPE_IPAD]
  },
  showXcodeLog: {
    isBoolean: true
  },
...
export { desiredCapConstraints, DEVICE_TYPE_TV, DEVICE_TYPE_IPHONE };
