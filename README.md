...
|`reduceMotion`| It allows to turn on/off reduce motion accestibility preference. Setting reduceMotion on helps to reduce flakyness on tests. Only fon simulators | e.g `true` |
