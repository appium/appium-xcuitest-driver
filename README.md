...
label | Element's [label](https://developer.apple.com/documentation/xctest/xcuielementattributes/1500692-label?language=objc) value. Could be `null`. The result started including `\n` as same as the `label` attribue in the XCUIElement since XCUITest driver 4.7.3 (WebDriverAgent 4.8.0) if the label included it. | 'hello', 'hello\nworld'
