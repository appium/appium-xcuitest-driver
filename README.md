...
Alternatively, you can create an Xcode config file with your code signing identity and team, and then specify the full path using the `xcodeConfigFile` deisred capability. For example,
