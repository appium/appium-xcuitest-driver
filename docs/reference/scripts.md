...
|--|--|--|--|
|`--appletv-device-id`|Identifier of a paired Apple TV device (returned by [`pair-appletv`](#pair-appletv)) to create the tunnel for. Repeat this argument to target multiple paired Apple TV devices. If omitted, the script creates one tunnel per discovered paired Apple TV device.|string (repeatable)||
...
|`--udid`, `-u`|Identifier of a specific device to create the tunnel for. Repeat this argument to target multiple specific devices. By default, the tunnel is created for all connected devices.|string (repeatable)||
...
- Create tunnels for multiple usbmux and AppleTV devices:
    ...
    ```
    sudo appium driver run xcuitest tunnel-creation -- --udid 00000000-1111-2222-3333-444444444444 --udid 55555555-6666-7777-8888-999999999999 --appletv-device-id 00000000-5555-9999-7777-444444444444
    ```
