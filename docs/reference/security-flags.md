...
|`xctest_record_screen`|Allow screen recording via XCTest using [`mobile: startXCTestScreenRecording`](./execute-methods.md#mobile-startxctestscreenrecording). Only required for real devices due to the inability to delete the recorded videos.|
